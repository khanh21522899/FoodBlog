      ...
      <div>
        ...
        <div className="blog-detail-container">
          <div className="blog-detail-hero-img">
            {detail?.images.length > 0 ? detail.images.map((img, index) =>
              <img
                key={index}
                src={img}
                onError={(e) => {
          ...
          <div className="blog-detail">
            <div className="blog-detail-author">
              <img src={detail?.author?.avatar ?? "/userpicture.jpeg"} alt="" onClick={handleAuthorInfo} />
              <div className="author-name" onClick={handleAuthorInfo} >By {detail?.author?.name ?? "User"}</div>
              <div>
